...
function RouteHeatmapLegend({
  ...
  const className = journal
    ? "pointer-events-none absolute bottom-4 left-4 z-1000 w-64 rounded-lg border border-border/50 bg-background/90 px-3 py-2.5 text-xs shadow-xs backdrop-blur-sm"
    : "absolute inset-x-0 bottom-0 z-1000 border-border/50 border-t bg-background/95 px-4 py-3 text-xs backdrop-blur-sm";
